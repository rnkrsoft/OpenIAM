...
<html>
	<head>
		...
		<title>${title}</title>
		<link rel="stylesheet" href="/static/login/css/animation.css" />
	...
	<body>
		<div class="container">
			...
			<div id="iam-content" style="z-index:999; display: none;position: absolute;top: 20%;right: 10%;flex-direction: row;width: 1100px;height: 442px;">
				<div id="iam-loading" style="background: #fff;display: flex;justify-content: center;align-content: center;">
					<div style="font-size: 20px;color: #333;">暂不支持该浏览器，请使用Chrome浏览器，
						<a href="https://www.google.cn/chrome/" target="_self" style="color: #09cece;">前往下载...</a>
					</div>
				</div>
				<div class="iam-info">
					<p>
				...
				<div class="iam-main">
					<div id="qrcode-login" class="iam-container qrcode-login" style="display: none;">
						<!--登录成功后跳转地址-->
						<input type="hidden" name="referrer" value="${referrer}">
						<div class="iam-view">
							<i class="icon iconfont iconfontqrcode" onclick="changeLoginType('password')"></i>
							<div><span class="iam-title">IAM</span></div>
						</div>
						
						<div style="text-align: center;">
							<p style="margin: 20px 0 30px;font-size: 18px;line-height: 25px;color: #000;font-weight: bold;">扫码登录</p>
						</div>
						
						<div style="text-align: center;">
							<img id="qrCodeImage" src="" alt="" style="width: 181px;height: 181px;"/>
						</div>
						<p id="qrCodeMsg" class="msg" style="text-align: center;"></p>

						<div class="lbtn" style="text-align: center;">
							<button class="login-btn" onclick="generateQrCode();">刷新二维码</button>
						</div>
						<div style="text-align: right;">
							<a href="#" style="font-size: 14px;color: #000;">下载 IAM令牌</a>
						</div>
					</div>
					<div id="password-login" class="iam-container password-login" style="display:none;">
						<form action="/sms/doLogin" method="post">
							<!--登录成功后跳转地址-->
							<input type="hidden" name="referrer" value="${referrer}">
							<div class="iam-view">
								<i class="icon iconfont iconfontpassword" onclick="changeLoginType('qrcode')"></i>
								<div><span class="iam-title">IAM</span></div>
							</div>
							<div style="text-align: center;">
								<p style="margin: 20px 0 30px;font-size: 18px;line-height: 25px;color: #000;font-weight: bold;">验证码登录</p>
							</div>
							<div style="text-align: center;">
								<input id="mobileNo" class="mobileNo" type="tel" name="mobileNo" value="" placeholder="请输入您的手机号码" maxlength="11">
							</div>
							<div style="text-align: center;">
								<input id="smsCode" class="smsCode" type="text" name="code" value="" placeholder="请输入短信验证码" maxlength="6">
								<button id="send-btn" class="send-btn" type="button" onclick="sendSmsCode();">获取验证码</button>
							</div>
							<div style="text-align: center;">
	...
	<script src="/static/login/js/animation.js"></script>
